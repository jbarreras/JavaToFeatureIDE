...
public class InterfazNumeroMvc extends JFrame implements ActionListener {
	...
	public InterfazNumeroMvc() {
		...
		itemNuevo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
		...
		itemSalir.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,
				ActionEvent.ALT_MASK));
	...
	public void crearNuevaVentana() {
		...
		String vc = (String) JOptionPane.showInputDialog(this,
				"Ventana a crear", "Ventana", JOptionPane.QUESTION_MESSAGE,
				null, new String[] { VC_NUMERO, VC_ROMANO, VC_COLOR, VC_NOTA,
						VC_BINARIO }, null);
		if (vc != null) {
	 ...
	 * 
	 * @param args
	 *            Argumentos para la ejecución de la aplicación. En este caso no
	 *            se requieren
	 */
